...
class TestSsd(unittest.TestCase):
    ...
    def test_ssd(self):
        ...
        expected = np.array([[540, 382,  71, 296, 392, 448, 427, 369],
                             [506, 432, 278, 282, 348, 425, 432, 408],
                             [498, 438, 285, 252, 336, 430, 463, 425],
                             [519, 392, 101, 257, 359, 468, 472, 408],
                             [437, 439, 431, 421, 414, 394, 374, 356],
                             [340, 482, 610, 546, 450, 267, 248, 325],
                             [346, 443, 593, 567, 439, 244, 250, 358],
                             [365, 486, 601, 550, 413, 248, 281, 357]])
